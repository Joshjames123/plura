...
export default function Home() {
  return (
    <main className="">
      <section className="h-full w-full pt-52 relative flex items-center justify-center flex-col ">
        {/* grid */}
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-40 mt-[15rem]">
